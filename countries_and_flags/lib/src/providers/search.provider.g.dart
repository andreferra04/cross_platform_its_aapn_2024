...
String _$searchHash() => r'8f4e37b3a65c6d8022b44b044f10957896a8c4fe';
...
/// See also [search].
class SearchFamily extends Family<AsyncValue<List<CountryModel>>> {
  /// See also [search].
  const SearchFamily();
...
/// See also [search].
class SearchProvider extends AutoDisposeFutureProvider<List<CountryModel>> {
  /// See also [search].
  SearchProvider(
    String? query,
  ) : this._internal(
  ...
  Override overrideWith(
    FutureOr<List<CountryModel>> Function(SearchRef provider) create,
  ) {
...
mixin SearchRef on AutoDisposeFutureProviderRef<List<CountryModel>> {
